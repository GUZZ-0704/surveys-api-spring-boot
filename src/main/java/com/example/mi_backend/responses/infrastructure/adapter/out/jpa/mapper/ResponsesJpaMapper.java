package com.example.mi_backend.responses.infrastructure.adapter.out.jpa.mapper;
...
import com.example.mi_backend.responses.infrastructure.adapter.out.jpa.entity.*;
    ...
    private static SubmissionAnswer toDomainAnswer(SubmissionAnswerEntity ae) {
        ...
        if (ae instanceof MatchingAnswerEntity me) {
            var pairs = me.getPairs().stream()
                    .map(p -> new com.example.mi_backend.responses.domain.model.MatchingPair(p.getLeftId(), p.getRightId()))
