package com.example.mi_backend.reports.domain.service;

import com.example.mi_backend.reports.domain.exception.UnsupportedQuestionForReportException;
import com.example.mi_backend.reports.domain.model.*;
import com.example.mi_backend.reports.domain.valueobject.PairKey;
import com.example.mi_backend.reports.domain.valueobject.ReportParams;
import com.example.mi_backend.responses.domain.model.*;
import com.example.mi_backend.responses.domain.valueobject.*;
