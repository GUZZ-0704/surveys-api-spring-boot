...
import com.example.mi_backend.questions.application.port.out.CreateMatchingQuestionPort;
import com.example.mi_backend.questions.domain.model.*;
...
public class CreateMatchingQuestionAdapter implements CreateMatchingQuestionPort {
    ...
    public Question create(Long formId, Long sectionId, int position, String prompt, String helpText, boolean required,
                           boolean shuffleRightColumn, java.util.List<String> leftTexts, java.util.List<String> rightTexts,
                           java.util.List<PairIdx> keyPairs) {
